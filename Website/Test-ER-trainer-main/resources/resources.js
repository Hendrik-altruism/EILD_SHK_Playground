...
//"number": 5,            // Anzahl zufällig abgefragter Phrasen (keine Angabe: alle Phrasen)
  ...
  "./resources/img/chen/1.svg","./resources/img/chen/c.svg", "./resources/img/chen/cn.svg", "./resources/img/chen/e.svg", "./resources/img/chen/n.svg", "./resources/img/chen/r.svg",
  ...
  "libs": ["ccm.load",
    [ 
      ...
      "./resources/webdav/web.index.js",
      "./resources/webdav/webdav.js",
      "./resources/webdav/highcharts.js"
   ]],
  ...
  "onchange": async event => {
    ...
    phrase.key = event.instance.helper.toKey(phrase.entities.concat(phrase.solution).join('_'));
